...
var TypingGame = function () {
    ...
    var _h = react_1.useState([10]), listOfWPMs = _h[0], SetListOfWPMs = _h[1];
    ...
    return (react_1["default"].createElement("div", { className: "flex-row" },
        react_1["default"].createElement(TopMenu_1["default"], null),
        react_1["default"].createElement("div", { className: "flex min-h-screen flex-col items-center font-mono h-48 font-semibold border" },
            startTime && (react_1["default"].createElement("h2", { style: { fontSize: 20 }, className: "fixed top-3 right-3 font-mono" },
                "Time: ",
                (elapsedTime / 1000).toFixed(1),
                " seconds")),
            react_1["default"].createElement("h2", { style: { fontSize: 20 }, className: "fixed bottom-10 right-10 font-mono" },
                "Highest WPM: ",
                highestWPM.toFixed(0)),
            react_1["default"].createElement("h2", { style: { fontSize: 15 }, className: "fixed bottom-50 left-10 font-mono" },
                "List of last 10 scores:",
                react_1["default"].createElement("br", null),
                " ",
                listOfWPMs[1]),
            react_1["default"].createElement("h2", { className: "text-4xl  mt-20 mb-20 " }, "Typing with ChatGPT"),
            react_1["default"].createElement("div", null,
                react_1["default"].createElement("div", { className: "text-center font-mono font-bold lg:max-w-2xl lg:w-full lg:mb-0 lg:grid-cols-2 lg:text-center w-0.5" },
                    react_1["default"].createElement("div", { className: "fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none" },
                        react_1["default"].createElement("div", { className: "mt-20 " }, textToType.split("").map(function (char, charIndex) {
            ...
            react_1["default"].createElement("div", null,
                ...
                react_1["default"].createElement("p", { className: "mt-5 font-mono" }, "\"Real quotes with a creepy twist, by Chat GPT\""),
