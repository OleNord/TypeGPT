...
var TypingGame = function () {
    ...
    return (react_1["default"].createElement("div", { className: "flex min-h-screen flex-col items-center font-mono h-48 font-semibold border" },
                ...
                react_1["default"].createElement("div", { className: "fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none" },
                    react_1["default"].createElement("div", { className: "mt-20 " }, textToType.split("").map(function (char, charIndex) {
                        ...
                        if (currentChar === '_') {
                            ...
                            (color = currentChar === char ? 'rgb(186, 186, 2)' : 'red');
                        }
                        var isChecked = false;
                        if (currentChar === char && !isChecked) {
                            correctChars++;
                            isChecked = true;
                        }
                        else {
